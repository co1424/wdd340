CREATE TYPE public."client_type" AS ENUM ('Client', 'Employee', 'Admin');
ALTER TYPE public."client_type" OWNER TO wdd340db;
...
WHERE client_id = 1;
-- Query 3: Delete existing record:
DELETE FROM public.client
WHERE client_id = 1;
-- Query 4: Replace function-Replace a string in an existing record:
...
-- Query 5: INNER JOIN to show vehicles under the 'Sport' classiffication.
SELECT (inv_make, inv_model, classification_name) AS Sport_Vehicles
FROM public.inventory AS i
    JOIN public.classification AS c ON i.classification_id = c.classification_id
WHERE c.classification_id = 2;
-- Query 6: Update inv_image and inv_thumbnail path:
UPDATE public.inventory
